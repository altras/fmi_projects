...
public partial class AdminProductDetails : System.Web.UI.Page
{
  ...
  private void PopulateControls()
  {
    ...
    catLink.NavigateUrl = "AdminProducts.aspx?DepartmentID="+currentDepartmentId+"&CategoryID="+currentCategoryId;
        //"AdminCategories.aspx?DepartmentID=" + currentDepartmentId;   
  ...
  protected void removeButton_Click(object sender, EventArgs e)
  {
    ...
    if (categoriesListRemove.SelectedIndex != -1)
    {
      ...
      statusLabel.Text = success ? "Хотелът е премахнат успешно" : "Хотелът не е премахнат успешно";
      // Refresh the page
      PopulateControls();
    }
    else
  ...
  protected void assignButton_Click(object sender, EventArgs e)
  {
    ...
    if (categoriesListAssign.SelectedIndex != -1)
    {
      ...
      // Display status message
      statusLabel.Text = success ? "Хотелът е зададен успешно" : "Хотелът не е зададен успешно";
      // Refresh the page
      PopulateControls();
    }
    else
  ...
  protected void moveButton_Click(object sender, EventArgs e)
  {
    ...
    if (categoriesListMove.SelectedIndex != -1)
    {
      ...
      if (!success)
        statusLabel.Text = "Хотелът не можеше да бъде преместен в дадената категория";
      else
  ...
  protected void upload1Button_Click(object sender, EventArgs e)
  {
    ...
    if (image1FileUpload.HasFile)
    {
      try
      {
        ...
        string location = Server.MapPath("./ProductImages1/") + fileName;
      ...
      {
        statusLabel.Text = "Качването на изображение 1 се провали";
      }
    }
  }
  ...
  protected void upload2Button_Click(object sender, EventArgs e)
  {
    ...
    if (image2FileUpload.HasFile)
    {
      ...
      {
        statusLabel.Text = "Качването на изображение 2 се провали";
      }
    }
  }
}
