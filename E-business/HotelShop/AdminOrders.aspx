...
<asp:Content ID="Content1" ContentPlaceHolderID="titlePlaceHolder" runat="Server">
  <span class="AdminTitle">Хотелски услуги
    <br />
    Поръчки </span>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="adminPlaceHolder" runat="Server">
  ...
  <asp:Button ID="byCustomerGo" runat="server" Text="Напред" OnClick="byCustomerGo_Click" />
  <br />
  Покажи поръчки по ИД
  <asp:TextBox ID="orderIDBox" runat="server" Width="77px" />
  <asp:Button ID="byIDGo" runat="server" Text="Напред" OnClick="byIDGo_Click" />
  <br />
  Покажи последните
  <asp:TextBox ID="recentCountTextBox" runat="server" MaxLength="4" Width="40px">20</asp:TextBox>
  поръчки
  <asp:Button ID="byRecentGo" runat="server" Text="Напред" OnClick="byRecentGo_Click" />
  <br />
  Покажи всички поръчки направени между (1/1/1999 - 1/1/2015)
  ...
  <br />
  Покажи всички поръчки чакащи потвърждаване за наличност
  <asp:Button ID="awaitingStockGo" runat="server" Text="Напред" OnClick="awaitingStockGo_Click" />
  <br />
  Покажи всички поръчки чакащи изпращане
  <asp:Button ID="awaitingShippingGo" runat="server" Text="Напред" OnClick="awaitingShippingGo_Click" />
  <br />
  <br />
  ...
  <asp:ValidationSummary ID="validationSummary" runat="server" CssClass="AdminError"
    HeaderText="Грешки при валидацията:" />
  <br />
  <asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" DataKeyNames="OrderID"
    OnSelectedIndexChanged="grid_SelectedIndexChanged">
    <Columns>
      <asp:BoundField DataField="OrderID" HeaderText="Поръчка ИД" ReadOnly="True" SortExpression="OrderID" />
