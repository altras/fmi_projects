...
<body>
	<form id="wrapper" runat="server">
		<header>
		<h1>Computer Configuration Number:
        ...
        <asp:HyperLink runat="server" id="mainPage" class="pagingnumber" NavigateUrl="~/Default.aspx">Main Page</asp:HyperLink>
		<footer>
		<h4>Copyright &#169; ASP programming</h4>
	</form>
</body>
</html>
