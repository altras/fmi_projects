...
<head>
	<title>ASP Проект- въвеждане</title>
...
<body>
    <form id="wrapper" runat="server">
        ...
        <asp:Panel ID="navigationSection" runat="server" CssClass="section">
            <asp:Button ID="SubmitButton" runat="server" Text="Въведи" OnClick="CreateNewEntry" CausesValidation="true" CssClass="buttons" /><br />
            <asp:HyperLink Id="ToMainPage" runat="server" NavigateUrl="~\Default.aspx" CssClass="buttons" >Към началната страница</asp:HyperLink>
        </asp:Panel>
    </form>
</body>
</html>
